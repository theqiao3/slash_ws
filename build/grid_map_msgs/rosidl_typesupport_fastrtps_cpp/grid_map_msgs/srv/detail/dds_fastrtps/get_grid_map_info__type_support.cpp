  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = grid_map_msgs::srv::GetGridMapInfo_Request;
    is_plain =
      (
...
static size_t _GetGridMapInfo_Request__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_GetGridMapInfo_Request(full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = grid_map_msgs::srv::GetGridMapInfo_Response;
    is_plain =
      (
...
static size_t _GetGridMapInfo_Response__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_GetGridMapInfo_Response(full_bounded, is_plain, 0);
